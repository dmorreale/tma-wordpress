	...
	<div class="pageContainer formContainer formAlt">
		...
		<div class="innerContainer">
			...
			<div class="mainContainer">
				...
				<p>麥卡倫學院-基礎課程是您探索之旅的開始。在完成本次由三部分組成的課程之後，您將加強您的威士忌知識，並更深入地瞭解麥卡倫無與倫比的品質和非凡創造力。本課程大約需要15分鐘才能完成。現在就展開您的旅程吧！</p>
				<div class="courseList">
					<span class="title">您的課程</span>
					<ul>
						<li>
							<a href="/tc/lessons/fundamentals-1-tc/"><span>威士忌101</span></a>
						</li>
						<li>
							<a href="/tc/lessons/fundamentals-2-tc/"><span>麥卡倫簡介</span></a>
						</li>
						<li>
							<a href="/tc/lessons/fundamentals-3-tc/"><span>麥卡倫雪利雙桶和经典雪利桶系列</span></a>
						</li>
					</ul>
				</div>
			</div>

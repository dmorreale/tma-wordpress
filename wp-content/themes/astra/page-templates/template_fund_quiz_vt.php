		...
		<div class="quizOverlay">
			<div class="overlayInner">
				...
				<div class="overlayMain">
					<div class="innerpad">
						<h3>Chúc mừng</h3>
						<p>Bạn vừa hoàn thành chương trình Kiến thức cơ bản của The Macallan Academy. Giờ đây, bạn đã nắm vững được kiến thức về whisky, The Macallan và hai dòng rượu tuyệt vời The Macallan Double Cask và The Macallan Sherry Oak để áp dụng vào thực tiễn công việc. Bạn đã đạt được chứng nhận dưới đây. Nhấp vào biểu tượng bên dưới để in hoặc tải chứng chỉ của bạn xuống.</p>
					</div>
...
<!--								<p>Share Link:</p><input style="width:60%;margin-left:20%;" type="text" value="themacallanacademy.com/?9HACWc7P4D6F9r8d"/><br/><p>Copy and share this link so others can enjoy The Macallan Academy Lite Experience</p>-->
					...
					<div class="graySection">
						<div class="innerpad">
							<span class="gsLabel gsLabelMain">Những lợi ích khác</span>
							<div class="gsTwoColumn">
								<div class="gscol gscol1">
									<div class="flexGrp">
										<span class="gsLabel">TÀI LIỆU CHO CHƯƠNG TRÌNH KIẾN THỨC CƠ BẢN CỦA THE MACALLAN ACADEMY</span>
										<p>Khi hoàn thành chương trình Kiến thức cơ bản về The Macallan, bạn có thể tải xuống những thẻ thông tin để tham khảo nhanh. Bạn có thể vào trang hồ sơ của mình để tải xuống và tham khảo những thẻ này bất kỳ khi nào bạn cần.</p>
									</div>
									<ul style="list-style:none;margin-top:20px;">
										...
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Casks.pdf" target="_blank">Thùng gỗ sồi đặc biệt</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Natural Colour.pdf" target="_blank">Màu sắc tự nhiên</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Spiritual Home.pdf" target="_blank">Ngôi nhà tinh thần</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Scotch Whisky Types.pdf" target="_blank">Rượu whisky Scotch</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCardsScotchWMP_EN_VI_091721.pdf" target="_blank">Quy trình làm rượu whisky</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCardsWoodTypes_EN_VI_091721.pdf" target="_blank">Các loại gỗ</a></li>
									</ul>
								</div>
								<div class="gscol gscol2">
									<div class="flexGrp">
										<span class="gsLabel">QUYỀN TRUY CẬP ĐẦY ĐỦ VÀO THE MACALLAN ACADEMY</span>
										<p>Khi hoàn thành chương trình Kiến thức cơ bản của The Macallan Academy, bạn sẽ có toàn quyền truy cập vào The Macallan Academy. Academy chính là nguồn thông tin đầy đủ nhất về The Macallan.</p>
									</div>
									<a href="/" class="colBtn">TRUY CẬP</a>
								</div>
							</div>
							<style>
								.liteCerts h4{
				...
				<div class="overlayFooter">
					<div class="overlayNav">
						<a href="/vi/courses/global-fundamentals-vi/">TRANG CHỦ</a>
						<a href="/vi/profile/">HỒ SƠ</a>
		...
		<header class="moduleHeader">
			<div>
				<span>Câu hỏi trắc nghiệm về chương trình Kiến thức cơ bản của The Macallan Academy</span>
				<a href="#"><img src="/wp-content/themes/astra/lite_academy/images/logo.png" alt=""></a>
			</div>
		</header>
		<div class="moduleSection quizIntro">
			<div class="sectionContent">
				<h1>Câu hỏi trắc nghiệm về<br> chương trình Kiến thức cơ<br> bản của The Macallan Academy</h1>
				<span>Hãy chọn đáp án đúng cho mỗi câu hỏi</span>
			</div>
		</div>
...
-->
		...
		<div class="moduleSection section17 knowledgeComplete">
			<div class="sectionContent">
				<h3>CHƯƠNG TRÌNH KIẾN THỨC CƠ BẢN CỦA THE MACALLAN ACADEMY</h3>

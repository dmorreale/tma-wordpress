		...
		<div class="quizOverlay">
			<div class="overlayInner">
				...
				<div class="overlayMain">
					<div class="innerpad">
						<h3>Félicitations !</h3>
						<p>YVous avez terminé le programme The Macallan Academy – Bases. Grâce à vos connaissances du whisky, de The Macallan et de deux de ses incroyables gammes de whisky – Double Cask et The Macallan Sherry Oak –, vous voilà désormais opérationnel·le. Cliquez sur l’icône ci-dessus pour imprimer ou télécharger votre certificat.</p>
					</div>
...
<!--								<p>Share Link:</p><input style="width:60%;margin-left:20%;" type="text" value="themacallanacademy.com/?9HACWc7P4D6F9r8d"/><br/><p>Copy and share this link so others can enjoy The Macallan Academy Lite Experience</p>-->
					...
					<div class="graySection">
						<div class="innerpad">
							<span class="gsLabel gsLabelMain">AUTRES AVANTAGES</span>
							<div class="gsTwoColumn">
								<div class="gscol gscol1">
									<div class="flexGrp">
										<span class="gsLabel">THE MACALLAN ACADEMY – BASES : RESSOURCES</span>
										<p>Ayant terminé le programme The Macallan Fundamentals, vous avez maintenant accès à des fiches info synthétiques téléchargeables. Vous pourrez les télécharger depuis votre page de profil à tout moment.</p>
									</div>
									<ul style="list-style:none;margin-top:20px;">
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/Double_Cask_fr.pdf" target="_blank">Double Cask</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/Exceptional_Casks_fr.pdf" target="_blank">D’Exceptionnels Fûts en Chêne</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/Natural_Colour_fr.pdf" target="_blank">Robe Naturelle</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/Spiritual_Home_fr.pdf" target="_blank">Notre Maison Spirituelle</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/Scotch_VS_American_fr.pdf" target="_blank">Scotch Whisky</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/Scotch_Making_Process_fr.pdf" target="_blank">Processus de Fabrication du Scotch Whisk</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/Wood_Types_fr.pdf" target="_blank">Types de Bois</a></li>
									</ul>
								</div>
								<div class="gscol gscol2">
									<div class="flexGrp">
										<span class="gsLabel">ACCÈS COMPLET À THE MACALLAN ACADEMY</span>
										<p>Ayant terminé le programme The Macallan Fundamentals, vous avez maintenant l’accès complet à The Macallan Academy. Notre Academy est votre source d’information exhaustive pour tout ce qui concerne The Macallan.</p>
									</div>
									<a href="/" class="colBtn">ENTRÉE / ENTRER</a>
								</div>
							</div>
							<style>
								.liteCerts h4{
				...
				<div class="overlayFooter">
					<div class="overlayNav">
						<a href="/fr/courses/global-fundamentals-fr/">ACCUEIL</a>
		...
		<header class="moduleHeader">
			<div>
				<span>The Macallan Academy – Bases : Quiz</span>
				<a href="#"><img src="/wp-content/themes/astra/lite_academy/images/logo.png" alt=""></a>
			</div>
		</header>
		<div class="moduleSection quizIntro">
			<div class="sectionContent">
				<h1>The Macallan<br> Academy –<br> Bases : Quiz</h1>
				<span>Pour chaque question<br>choisissez la bonne réponse</span>
			</div>
		</div>
...
-->
		...
		<div class="moduleSection section17 knowledgeComplete">
			<div class="sectionContent">
				<h3>The Macallan<br> Academy – Bases</h3>
				<span>ACHEVÉ</span>
			</div>
		</div>

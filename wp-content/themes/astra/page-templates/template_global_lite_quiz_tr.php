...
//global $wpdb;
/*
 Template Name: Global LITE Quiz Turkish
Template Post Type: sfwd-courses, sfwd-lessons, sfwd-topic, sfwd-quiz
*/

$advQuiz = do_shortcode('[LDAdvQuiz 215]');
		...
		<div class="quizOverlay">
			<div class="overlayInner">
				...
				<div class="overlayMain">
					<div class="innerpad">
						<h3>Tebrikler</h3>
						<p>The Macallan Academy Temel Bilgiler programını başarıyla tamamladınız. Artık viski, The Macallan'ın iki inanılmaz viski serisi olan, Macallan Double Cask ve Macallan Sherry Oak serileri hakkında temel bilgi sahibisiniz. Sertifikanızı yazdırmak veya indirmek için aşağıdaki simgeye tıklayınız.</p>
					</div>
					<style>
...
<!--								<p>Share Link:</p><input style="width:60%;margin-left:20%;" type="text" value="themacallanacademy.com/?9HACWc7P4D6F9r8d"/><br/><p>Copy and share this link so others can enjoy The Macallan Academy Lite Experience</p>-->
					...
					<div class="graySection">
						<div class="innerpad">
							<span class="gsLabel gsLabelMain">Diğer Ayrıcalıklar</span>
							<div class="gsTwoColumn">
								<div class="gscol gscol1">
									<div class="flexGrp">
										<span class="gsLabel">MACALLAN AKADEMİSİ TEMEL BİLGİLER KAYNAKLAR</span>
										<p>The Macallan Temel Bilgiler programını tamamladıktan sonra, artık hızlı başvuru için indirilebilir bilgi kartlarına erişebilirsiniz. <a href="/profile" target="_blank">İhtiyacınız olduğunda indirmek ve referans almanız için profil sayfanızda her daim bulunacaktır.</a></p>
									</div>
									<ul style="list-style:none;margin-top:20px;">
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_TK_Overview.pdf" target="_blank">Double Cask</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_TK_ExceptionalCasks.pdf" target="_blank">Olağanüstü Meşe Fıçıları</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_TK_NaturalColor.pdf" target="_blank">Doğal Renk</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_TK_SpiritualHome.pdf" target="_blank">Spiritual Home</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_TK_ScotchWhisky.pdf" target="_blank">İskoç Viskisi</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_TK_Process.pdf" target="_blank">İskoç Viskisi Üretim Süreci</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_TK_WoodTypes.pdf" target="_blank">Ahşap Çeşitleri</a></li>
									</ul>
								</div>
								<div class="gscol gscol2">
									<div class="flexGrp">
										<span class="gsLabel">MACALLAN AKADEMİSİ'NE TAM ERİŞİM</span>
										<p>The Macallan Academy Temel Bilgiler programını tamamladıktan sonra, artık The Macallan Academy'ye tam erişim sağlayabilirsiniz.  Akademimiz, The Macallan ile ilgili bilmek istediğiniz her şey için kapsamlı bir kaynaktır.</p>
									</div>
									<a href="/" class="colBtn">GİRİŞ</a>
								</div>
							</div>
							<style>
								.liteCerts h4{
				...
				<div class="overlayFooter">
					<div class="overlayNav">
						<a href="/courses/global-fundamentals-en/">ANASAYFA</a>
						<a href="/profile/">PROFİL</a>
		...
		<header class="moduleHeader">
			<div>
				<span>TThe Macallan Akademisi Temel Bilgiler Testi</span>
				<a href="#"><img src="/wp-content/themes/astra/lite_academy/images/logo.png" alt=""></a>
			</div>
		</header>
		<div class="moduleSection quizIntro">
			<div class="sectionContent">
				<h1>The Macallan <br/>Akademisi Temel <br/>Bilgiler Testi</h1>
				<span>Her sorunun doğru <br>cevabı seçiniz</span>
			</div>
		</div>
...
-->
		...
		<div class="moduleSection section17 knowledgeComplete">
			<div class="sectionContent">
				<h3>The Macallan Academy<br/> TEMEL BİLGİLERİ</h3>

<?php
/*
 Template Name: Fundamentals Landing - JP
	...
	<div class="pageContainer formContainer formAlt">
		...
		<div class="innerContainer">
			<div class="header">
				...
				<h1>The Macallan Academy Fundamentals</h1>
...
-->
			...
			<div class="mainContainer">
				...
				<p>ザ・マッカランアカデミー - 基礎プログラムでザ・マッカランの基本を学んでください。この3部構成のコースを修了することで、ウイスキーに関する知識を深め、ザ・マッカランの代名詞「比類なきクオリティと卓越したクリエイティビティ」についてよりよく理解することができます。このコースの所要時間は約15分です。今すぐ開始してください。</p>
				<div class="courseList">
					<span class="title">あなたのコース</span>
					<ul>
						<li>
							<a href="/ja/lessons/fundamentals-1-ja/"><span>ウイスキー101</span></a>
						</li>
						<li>
							<a href="/ja/lessons/fundamentals-2-ja/"><span>ザ・マッカランについて</span></a>
						</li>
						<li>
							<a href="/ja/lessons/fundamentals-3-ja/"><span>ザ・マッカランダブルカスク＆シェリーオークシリーズ</span></a>
						</li>
					</ul>
				</div>
			</div>

...
//global $wpdb;
/*
 Template Name: Fund. Quiz - ES
Template Post Type: sfwd-courses, sfwd-lessons, sfwd-topic, sfwd-quiz
*/

$advQuiz = do_shortcode('[ld_quiz quiz_id="118965"]');
			...
			<div class="overlayInner">
				...
				<div class="overlayMain">
					<div class="innerpad">
						...
						<p>Has completado The Macallan Academy Fundamentals programme. Ahora tienes un conocimiento práctico de whisky, The Macallan y dos increíbles gamas de whisky, The Macallan Double Cask y The Macallan Sherry Oak. Haz Click en el ícono abajo para imprimir o descargar tu certificado.</p>
					</div>
...
<!--								<p>Share Link:</p><input style="width:60%;margin-left:20%;" type="text" value="themacallanacademy.com/?9HACWc7P4D6F9r8d"/><br/><p>Copy and share this link so others can enjoy The Macallan Academy Lite Experience</p>-->
					...
					<div class="graySection">
						<div class="innerpad">
							<span class="gsLabel gsLabelMain">MÁS BENEFICIOS</span>
							<div class="gsTwoColumn">
								<div class="gscol gscol1">
									<div class="flexGrp">
										<span class="gsLabel">RECURSOS DE THE MACALLAN ACADEMY FUNDAMENTALS</span>
										<p>Una vez completado el The Macallan Fundamentals programme, tú tienes acceso a tarjetas informativas descargables para referencia rápida. Estas estarán en tu página de perfil para descargar y utilizar de referencia en el momento que los necesites. </p>
									</div>
									<ul style="list-style:none;margin-top:20px;">
										...
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Casks.pdf" target="_blank">Barricas de Roble Excepcionales</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Natural Colour.pdf" target="_blank">Color Natural </a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Spiritual Home.pdf" target="_blank">Nuestra Casa Espiritual </a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Scotch Whisky Types.pdf" target="_blank">Whisky Escocés</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCardScotchWMP_ESP_091721.pdf" target="_blank">Proceso de Elaboración de Whisky</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCardsWoodTypes_ESP_091721.pdf" target="_blank">Tipos de Madera</a></li>
									</ul>
								</div>
								<div class="gscol gscol2">
									<div class="flexGrp">
										<span class="gsLabel">ACCESO COMPLETO A THE MACALLAN ACADEMY</span>
										<p>Una vez completado el The Macallan Academy Fundamentals programme, tú tienes acceso completo al The Macallan Academy. Nuestro Academy es tu recurso comprensivo para todos los temas de The Macallan. </p>
									</div>
									<a href="/" class="colBtn">ENTRAR</a>
								</div>
							</div>
							<style>
								.liteCerts h4{
				...
				<div class="overlayFooter">
					<div class="overlayNav">
						<a href="es/courses/global-fundamentals-es/">INICIO</a>
						<a href="es/profile/">PERFILE</a>
						<a href="/terms-of-use">Términos y Condiciones</a>
		...
		<header class="moduleHeader">
			<div>
				<span>Prueba del The Macallan Academy Fundamentals </span>
				<a href="#"><img src="/wp-content/themes/astra/lite_academy/images/logo.png" alt=""></a>
			</div>
		</header>
		<div class="moduleSection quizIntro">
			<div class="sectionContent">
				<h1>Prueba del <br>The Macallan Academy<br> Fundamentals </h1>
				<span>Seleciona la contestación correcta <br>para cada pregunta</span>
			</div>
		</div>
...
-->
		...
		<div class="moduleSection section17 knowledgeComplete">
			<div class="sectionContent">
				<h3>The Macallan <br>Academy FundamentalEs</h3>

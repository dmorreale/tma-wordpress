...
$advQuiz = do_shortcode('[ld_quiz quiz_id="118955"]');
//var_dump($advQuiz);
//var_dump($advQuiz);
?>
<!doctype html>
...
<!--								<p>Share Link:</p><input style="width:60%;margin-left:20%;" type="text" value="themacallanacademy.com/?9HACWc7P4D6F9r8d"/><br/><p>Copy and share this link so others can enjoy The Macallan Academy Lite Experience</p>-->
							...
							<div class="gsTwoColumn">
								<div class="gscol gscol1">
									<div class="flexGrp">
										...
										<p>Upon completion of The Macallan Academy Fundamentals programme, you now have access to downloadable information cards for quick reference. They will be in your profile page for download and reference anytime you need them.</p>
									</div>
									<ul style="list-style:none;margin-top:20px;">
										...
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCardsScotchWMP_EN_JA_091721.pdf" target="_blank">Scotch Whisky-making Process</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCardsWoodTypes_EN_JA_091721.pdf" target="_blank">Wood Types</a></li>
									</ul>
								</div>
				...
				<div class="overlayFooter">
					<div class="overlayNav">
						<a href="/ja/courses/global-fundamentals-ja/">Home</a>
						<a href="/ja/profile/">Profile</a>
						<a href="/terms-of-use">ご利用規約</a>

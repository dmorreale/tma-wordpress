	...
	<div class="pageContainer formContainer formAlt">
		...
		<div class="innerContainer">
			<div class="header">
				...
				<h1>The Macallan Academy Fundamentals Programme</h1>
			...
			<div class="mainContainer">
				...
				<p>The Macallan Academy – Fundamentals programme es donde comienza tu viaje de conocimiento. Completando las tres partes de este curso, vas a fortalecer tu conocimiento de whisky y ganarás un profundo entendimiento de la incomparable calidad y excepcional creatividad de la que es sinónimo de The Macallan. El curso tomará aproximadamente 15 minutos para completar. Tu viaje comienza ahora</p>
				<div class="courseList">
					<span class="title">Tus Cursos</span>
					<ul>
						<li>
							<a href="/es/lessons/fundamentals-1-es/"><span>Whisky 101</span></a>
						</li>
						<li>
							<a href="/es/lessons/fundamentals-2-es/"><span>Introducción a The Macallan</span></a>
						</li>
						<li>
							<a href="/es/lessons/fundamentals-3-es/"><span>La Gama The Macallan Double Cask y Sherry Oak</span></a>
						</li>
					</ul>
				</div>
			</div>

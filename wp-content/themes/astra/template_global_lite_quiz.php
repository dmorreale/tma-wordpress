			...
			<div class="overlayInner">
				...
				<div class="overlayMain">
					<div class="innerpad">
						...
						<p>You just completed The Macallan Academy Fundamentals programme. You now have a working knowledge of whisky, The Macallan and two incredible whisky ranges, The Macallan Double Cask and The Macallan Sherry Oak. Click the icon below to print or download your certificate.</p>
					</div>
...
<!--								<p>Share Link:</p><input style="width:60%;margin-left:20%;" type="text" value="themacallanacademy.com/?9HACWc7P4D6F9r8d"/><br/><p>Copy and share this link so others can enjoy The Macallan Academy Lite Experience</p>-->
						...
						<div class="innerpad">
							...
							<div class="gsTwoColumn">
								<div class="gscol gscol1">
									<div class="flexGrp">
										<span class="gsLabel">The Macallan Academy Fundamentals Resources</span>
										<p>Upon completion of The Macallan Academy Fundamentals programme, you now have access to downloadable information cards for quick reference. <a href="/profile" target="_blank">They will be in your profile page for download and reference anytime you need them.</a></p>
									</div>
									<ul style="list-style:none;margin-top:20px;">
										...
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Casks.pdf" target="_blank">Exceptional Oak Casks</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Natural Colour.pdf" target="_blank">Natural Colour</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Spiritual Home.pdf" target="_blank">Our Spiritual Home</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCards_062521_Scotch Whisky Types.pdf" target="_blank">Scotch Whisky</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCardsScotchMaking Process_091721.pdf" target="_blank">Scotch Whisky-making Process</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TheMacallan_FactCardsWoodTypes_091721.pdf" target="_blank">Wood Types</a></li>
									</ul>
								</div>
								<div class="gscol gscol2">
									<div class="flexGrp">
										<span class="gsLabel">Full Access to the Macallan Academy</span>
										<p>Upon completion of The Macallan Academy Fundamentals programme, you now have full access to The Macallan Academy. Our Academy is your comprehensive resource for all things The Macallan.</p>
									</div>
									<a href="/" class="colBtn">Enter</a>
								</div>
							</div>
							<style>
								.liteCerts h4{
				...
				<div class="overlayFooter">
					<div class="overlayNav">
						<a href="/courses/global-fundamentals-en/">Home</a>
...
-->
		...
		<div class="moduleSection section17 knowledgeComplete">
			<div class="sectionContent">
				<h3>The Macallan <br>Academy Fundamentals</h3>
				<span>Completed</span>
			</div>
		</div>

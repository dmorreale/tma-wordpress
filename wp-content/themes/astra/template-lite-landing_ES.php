	...
	<div class="pageContainer formContainer formAlt">
		...
		<div class="innerContainer">
			...
			<div class="mainContainer">
				...
				<p>Academy Lite es una breve introducción al mundo del whisky y de The Macallan. Amplíe sus conocimientos y descubra la calidad excepcional y la complejidad de los whiskies de The Macallan con la ayuda de tres cursos breves. Comience ahora su viaje.</p>

				<div class="courseList">

					<span class="title">Sus cursos</span>

					<ul>

						<li>

							<a href="/es/lessons/lite-module-1-spanish/"><span>Introducción al whisky</span></a>

						</li>

						<li>

							<a href="/es/lessons/lite-module-2-spanish/"><span>Introducción a The Macallan</span></a>

						</li>

						<li>

							<a href="/es/lessons/lite-module-3-spanish/"><span>Las Gamas Double Cask y Sherry Oak de The Macallan</span></a>

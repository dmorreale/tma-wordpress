...
$advQuiz = do_shortcode('[ld_quiz quiz_id="79764"]');
//$advQuiz1 = do_shortcode('[ld_quiz quiz_id="80058"]');
//var_dump($advQuiz);
//var_dump($advQuiz);
?>
<!doctype html>
		...
		<div class="quizOverlay">
			<div class="overlayInner">
				...
				<div class="overlayMain">
					<div class="innerpad">
						<h3>Parabéns</h3>
						<p>Você acabou de concluir a Experiência Macallan Academy Lite. Agora, você tem um conhecimento prático sobre uísque, a Macallan e duas incríveis variedades de uísque, o Macallan Double Cask e o Macallan Sherry Oak. A insígnia abaixo é sua. Clique em um botão e compartilhe sua experiência em suas redes sociais favoritas. A insígnia abaixo é sua. Clique em um botão e compartilhe sua experiência em suas redes sociais favoritas.</p>
					</div>
...
<!--					<button class="sharebtn">Share</button>-->
					...
					<div class="graySection">
						<div class="innerpad">
							<span class="gsLabel gsLabelMain">MAIS VANTAGENS</span>
							<div class="gsTwoColumn">
								<div class="gscol gscol1">
									<div class="flexGrp">
										<span class="gsLabel">OS RECURSOS DA MACALLAN ACADEMY LITE</span>
										<p>Após a conclusão da Experiência Macallan Academy Lite, você agora pode fazer download dos cartões de informações para consulta rápida. Eles estarão disponíveis para download e referência na sua página de perfil sempre que precisar.</p>
									</div>
									<ul style="list-style:none;margin-top:20px;">
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/MAC_1.ALinhaDC_071420.pdf" target="_blank">Double Cask</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/MAC_3.ExceptionalCasks_071420.pdf" target="_blank">Exceptional Oak Cask</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/MAC_4.CorNatural_071420.pdf" target="_blank">Cor natural</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/MAC_2.ACasadoDestilado_071420.pdf" target="_blank">A casa do destilado</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/MAC_5.UisqueEscoces_071420.pdf" target="_blank">Uísque escocês</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/MAC_6.ProcessodeProduçao_071420.pdf" target="_blank">Processo de produção do uísque</a></li>
										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/MAC_7.TiposdeMadeira_071420.pdf" target="_blank">Tipos de madeira</a></li>
									</ul>
								</div>
								<div class="gscol gscol2">
									<div class="flexGrp">
										<span class="gsLabel">ACESSO TOTAL À MACALLAN ACADEMY</span>
										<p>Após a conclusão da Experiência Macallan Academy Lite, você agora tem acesso total à Macallan Academy. A Academy é a sua ferramenta abrangente para conhecer todos os produtos da Macallan.</p>
									</div>
									<a href="https://themacallanacademy.com/" class="colBtn">ENTRAR</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="overlayFooter">
					<div class="overlayNav">
						<a href="https://themacallanacademy.com/courses/lite-academy/">INÍCIO</a>
		...
		<header class="moduleHeader">
			<div>
				<span>Teste da Macallan Academy Lite</span>
				<a href="#"><img src="/wp-content/themes/astra/lite_academy/images/logo.png" alt=""></a>
			</div>
		</header>
		<div class="moduleSection quizIntro">
			<div class="sectionContent">
				<h1>Teste <br>da Macallan Academy<br>Lite</h1>
				<span>Selecione a resposta correta<br>para cada pergunta</span>
			</div>
		</div>

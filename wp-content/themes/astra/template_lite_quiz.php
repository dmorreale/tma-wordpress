...
$advQuiz = do_shortcode('[LDAdvQuiz 23]');
			...
			<div class="overlayInner">
				...
				<div class="overlayMain">
					...
					<div class="innerpad">
						...
						<p>You just completed The Macallan Academy Lite Experience. You now have a working knowledge of whisky, The Macallan and two incredible whisky ranges, The Macallan Double Cask and The Macallan Sherry Oak Cask. The badge below is yours. Click a button and share your experience with your favorite social networks.</p>
...
<!--					<button class="sharebtn">Share</button>-->
					...
					<div class="graySection">
						...
						<div class="innerpad">
							...
							<span class="gsLabel gsLabelMain">More Benefits</span>
							...
							<div class="gsTwoColumn">
								...
								<div class="gscol gscol1">
									...
									<div class="flexGrp">
										...
										<span class="gsLabel">The Macallan Academy Lite Resources</span>

										<p>Upon completion of The Macallan Academy Lite Experience, you now have access to downloadable fact cards for quick reference. They will be in your profile page for download and reference anytime you need them.</p>

									</div>

									<ul style="list-style:none;margin-top:20px;">

										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TEP Double Cask.pdf" target="_blank">Double Cask</a></li>

										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TEP Exceptional Oak Casks.pdf" target="_blank">Exceptional Oak Cask</a></li>

										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TEP Natural Color.pdf" target="_blank">Natural Color</a></li>

										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TEP Our Spiritual Home.pdf" target="_blank">Our Spiritual Home</a></li>

										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TEP Scotch Whisky.pdf" target="_blank">Scotch Whisky</a></li>

										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TEP Whisky-Making Process.pdf" target="_blank">Whisky Making Process</a></li>

										<li style="list-style:none;text-align:center;"><a href="/wp-content/themes/astra/lite_academy/resources/TEP Wood Types.pdf" target="_blank">Wood Types</a></li>
								...
								<div class="gscol gscol2">
									...
									<div class="flexGrp">
										...
										<span class="gsLabel">Full Access to the Macallan Academy</span>

										<p>Upon completion of The Macallan Academy Lite Experience, you now have full access to The Macallan Academy. The Academy is your comprehensive resource for all things The Macallan.</p>

									</div>

									<a href="https://themacallanacademy.com/" class="colBtn">Enter</a>
				...
				<div class="overlayFooter">
					...
					<div class="overlayNav">
						...
						<a href="https://themacallanacademy.com/courses/lite-academy/">Home</a>

						<a href="https://themacallanacademy.com/profile/">Profile</a>
		...
		<header class="moduleHeader">
			...
			<div>
				...
				<span>The Macallan Academy Lite Quiz</span>
		...
		<div class="moduleSection quizIntro">
			...
			<div class="sectionContent">
				...
				<h1>The Macallan <br>Academy <br>Lite Quiz</h1>

				<span>Select the correct answer <br>to each question</span>

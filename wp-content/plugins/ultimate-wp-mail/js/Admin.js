...
function EWD_UWPM_Enable_Disable_Send_On_Fields() {
	...
	jQuery('.ewd-uwpm-action-type-select').on('change', function() {
		if (jQuery(this).val() == 'Product_Added' || jQuery(this).val() == 'Product_Purchased' || jQuery(this).val() == 'WC_X_Time_Since_Cart_Abandoned') {
...
function EWD_UWPM_List_Edit_Handlers() {
	...
	jQuery('.ewd-uwpm-email-list-details').on('click', function() {console.log("Clicked");
		var List_Name = jQuery(this).html(); console.log(jQuery(this)); console.log(List_Name);
		...
		jQuery('.ewd-uwpm-list-name').val(jQuery.trim(List_Name));

	...
	<thead>
		<tr>
			<th scope='col' class='manage-column column-type sortable desc'  style="">
				<?php if (isset($_GET['OrderBy']) and $_GET['OrderBy'] == "Username" and $_GET['Order'] == "ASC") { echo "<a href='admin.php?page=EWD-UWPM-Options&DisplayPage=UserStats&OrderBy=Username&Order=DESC'>";}

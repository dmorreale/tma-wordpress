							...
							<table class='ewd-uwpm-advanced-event-table'>
								...
								?>
									<tr class='ewd-uwpm-wc-advanced-event' data-sendid='<?php echo $Advanced_Send_On['Send_On_ID']; ?>'>
										...
										<td><select name='Send_On_Includes_<?php echo $Counter; ?>' <?php echo (($Advanced_Send_On['Action_Type'] != 'Product_Added' and $Advanced_Send_On['Action_Type'] != 'Product_Purchased' and $Advanced_Send_On['Action_Type'] != 'WC_X_Time_Since_Cart_Abandoned') ? 'disabled' : ''); ?> class='ewd-uwpm-send-on-includes-select'>

...
Tags: mail, email, emails, customer relationship management, crm, woocommerce crm, woocommerce emails, email send, email blast, message, message users, email users, Ultimate WP Mail
Requires at least: 4.0.0
Tested up to: 5.5
License: GPLv3
License URI:http://www.gnu.org/licenses/gpl-3.0.html

Send emails to users quick and easily. Send WooCommerce emails to purchasers, abandoned carts. Advanced customizazble automatic WooCommerce email and non WooCommerce email sending actions.

== Description ==

Send emails quickly and easily with Ultimate WP Mail. Perfect for those who need advanced WooCommerce email sending functionality, for those looking to enhance their customer relationship management CRM experience, and for many other automatic email sending requirements in WordPress. 

= Email Sending Key Features =
...
* Trigger automtatic email sending for specific actions (e.g. user registration, new post published, etc.)
* Great email previewing and scheduled sending features
* Included email templates for common emails

<strong>Includes a Gutenberg block for the subscription interests, which makes setting that up a breeze!</strong>

With <strong>WooCommerce email</strong> integration! Send emails from WooCommerce manually and/or automatically to WooCommerce purchasers, those who abandon a cart in WooCommerce, and more. See the <strong>"WooCommerce Email Sending"</strong> section below for more details.

[youtube https://www.youtube.com/watch?v=spGdk3sZlpI]

Ultimate WP Mail is an easy-to-use plugin that let's you create customized WooCommerce emails and non WooCommerce emails that you can send directly to registered users on your site. You can quickly create and send an automatic email message to a single user, to a group of users or an email blast to all users. These emails can be created manually (for one-time email sends) and/or automatically for specific actions, including a host of WooCommerce email actions. 

It's the perfect tool for creating an email list, email subscription or newsletter signup, and for those looking to strengthen their CRM (customer relationship management) email toolset. You can schedule emails to send at any time and then track the email statistics after it is sent. The included templates, as well as the email builder tool, create a responsive email that will look good when opened on any device

= WooCommerce Email Sending =

Ultimate WP Mail comes with a suite of built-in WooCommerce email integration features, which give you the ability to send emails to WooCommerce users on your site, including specific subsets of WooCommerce users (e.g. previous purchasers of a certain product), and also to create automatic WooCommerce email send triggers for specific WooCommerce actions (e.g. WooCommerce email to a someone who has an abandoned cart, new product added in WooCommerce, etc.). WooCommerce email sending features include:

* Send WooCommerce emails to past purchasers of specific products or products within a specific category
* Mix and match this with custom lists you've created for perfectly targeted WooCommerce emails, the perfect CRM for WooCommerce!
* Assign a specific email to send to users when a new WooCommerce product is added
* Automatically email users who have an abandoned cart, to help boost WooCommerce conversions
* Send an automatic email a specific amount of time after a WooCommerce purchase (e.g. as a follow up or requesting a review, etc.)

Ultimate WP Mail has many WooCommerce and non WooCommerce email sending features that make it the ideal choice for someone who is looking for an easy way to compose and send emails out to their registered WordPress users and WooCommerce customers. It will help you improve your CRM workfolow and experience.

You can create an unlimited number of emails, which you can then use to send out specific one-time messages or as templates for repeated messages. You can then also use the built-in "Send Events" features to automatically send one of the email templates you've composed when a certain action happens (such as an email when a new user registers, an email when a new comment is posted, an email when a new published post, an email for WooCommerce abandoned carts, an email to WooCommerce purchasers, etc.).

= Additional Features =

Ultimate WP Mail comes with a number of advanced email sending features and functionalities that will help you make your email management and email sending as efficient and effective as possible. Additional features include:

* Add a sign-up / subscription area to your site, and include option to specify interests
...
* Specific email send triggers for user actions, such as updating profile, changing password, etc.
...
Set up WooCommerce reminders and WooCommerce notifications, as well as email reminders for other elements. Create email notifications for specific actions and send emails directly to your users. With Ultimate WP Mail, the email sending possibilities are endless.
...
* Our FAQ page, here: https://wordpress.org/plugins/ultimate-wp-mail/#faq/
* Our installation guide, here: https://wordpress.org/plugins/ultimate-wp-mail/#installation/
* The Ultimate WP Mail support forum, here: https://wordpress.org/support/plugin/ultimate-wp-mail/
...
1. The email editor
2. WooCommerce email setup
3. Select list for email
4. Ultimate WP Mail comes with built-in email templates
5. Full-screen email editor
6. Basic area of the Options tab
7. Send Events area of the Options tab
8. Lists area of the Options tab
9. The Product Showcase email template, as sent
10. The Newsletter email template, as sent
11. The Promotion email template, as sent
12. The Thank You email template, as sent
13. The Follow Up email template, as sent
14. The Tutorial email template, as sent
